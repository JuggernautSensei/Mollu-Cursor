...
void ReadMePopup::operator()() const
{
    if (ImGui::BeginTabBar("ReadMePopup"))
    {
        if (ImGui::BeginTabItem("필독"))
        {
            ...
            ImGui::TextUnformatted("블루 아카이브는 ex스킬 조준 도중에 다른 키를 누르면 조준이 풀립니다.\n"
            ...
            ImGui::BulletText("2줄요약");
            ImGui::TextUnformatted("1. 블루아카이브에 매크로 쓸 때 알파벳과 숫자 및 상당히 많은 단축키를 사용하지 못함.\n"
                                   "2. F1~F12, Tab, Ctrl, Alt, Shift, Cap lock 는 사용가능한 걸로 확인됨.\n");
